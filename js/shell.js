...
const NAV_ICONS = {
  ...
  marketplace:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M4 9h16l-1 11H5L4 9z"/><path d="M7 9V6a5 5 0 0110 0v3M8 13h8"/></svg>',
  applications:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M5 4h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2z"/><path d="M7 9h10M7 13h7M7 17h5"/></svg>',
  hired:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="9" cy="8" r="3"/><path d="M3 20c0-3.5 2.7-6 6-6s6 2.5 6 6M16 11l2 2 4-4"/></svg>',
  findworkers:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4.3-4.3"/></svg>',
  postjob:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M12 5v14M5 12h14"/></svg>',
  myjobs:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M3 7l9-4 9 4-9 4-9-4z"/><path d="M3 7v10l9 4 9-4V7"/></svg>',
  offers:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M20 12v7a1 1 0 01-1 1H5a1 1 0 01-1-1v-7"/><path d="M2 7h20v5H2z"/><path d="M12 22V7"/></svg>',
  findjobs:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><circle cx="11" cy="11" r="7"/><path d="M21 21l-4.3-4.3"/></svg>',
  myapplications:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><path d="M5 4h14a2 2 0 012 2v12a2 2 0 01-2 2H5a2 2 0 01-2-2V6a2 2 0 012-2z"/><path d="M7 9h10M7 13h7M7 17h5"/></svg>',
  mywork:'<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.6"><rect x="3" y="7" width="18" height="13" rx="1"/><path d="M8 7V5a2 2 0 012-2h4a2 2 0 012 2v2"/></svg>'
};
...
const ALLOWED_PAGES_BY_ROLE = {
  contractor: ["dashboard","projects","workers","attendance","payments","materials","expenses","budget","progress","requests","documents","notifications","profile","support","reports",
    "findworkers","postjob","myjobs","applications","offers","hired","jobdetail","workerprofileview"],
  ...
  worker: ["dashboard","attendance","payments","notifications","profile","support",
    "findjobs","myapplications","offers","mywork","jobdetail"],
...
const NAV_BY_ROLE = {
  contractor: [
    ...
    { group:"Labour Marketplace", items:[
      ["findworkers","Find Workers","find-workers.html"], ["postjob","Post Job","post-job.html"],
      ["myjobs","My Jobs","my-jobs.html"], ["applications","Applications","applications.html"],
      ["offers","Job Offers","offers.html"], ["hired","Hired Workers","hired-workers.html"]
    ]},
  ...
  worker: [
    ...
    { group:"Labour Marketplace", items:[
      ["findjobs","Find Jobs","find-jobs.html"], ["myapplications","My Applications","my-applications.html"],
      ["offers","Job Offers","offers.html"], ["mywork","My Work","my-work.html"]
    ]},
    { group:"Account", items:[["notifications","Notifications","notifications.html"], ["profile","Profile","profile.html"], ["support","Support","support.html"]] }
  ],
  accountant: [
