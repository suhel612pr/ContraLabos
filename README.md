...
│   ├── marketplace-migration.sql jobs, applications, hiring + RLS policies
...
├── projects.html / project-detail.html / marketplace.html / applications.html / hired-workers.html
